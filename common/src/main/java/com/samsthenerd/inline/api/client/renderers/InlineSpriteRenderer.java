...
public class InlineSpriteRenderer implements InlineRenderer<SpriteInlineData>{
    ...
    public GlowHandling getGlowPreference(SpriteInlineData forData){
        return new GlowHandling.Full(Objects.requireNonNullElse(forData.sprite.getTextureId(), new Identifier("")).toTranslationKey() + Integer.toHexString(forData.sprite.hashCode()).toLowerCase());
    }
}
